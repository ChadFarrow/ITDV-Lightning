    ...
    const albumsToUse = albums.filter(album => album.title !== 'LNURL Testing Podcast');
      ...
      const sortWithHierarchy = (albums: Album[]) => {
        return albums.sort((a, b) => {
          ...
          const pinnedOrder = ["Disco Swag - The Album", "Bloodshot Lies - The Album", "Think EP", "Music From The Doerfel-Verse", "Autumn Rust", "Ben Doerfel", "Jam with Nate", "Beware of Banjo"];
